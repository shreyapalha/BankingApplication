...
<div class="container">
   <f:form action="successWithdrawal" modelAttribute="withdrawCommand">
   <div class="heading"><h2>Withdrawal Form</h2></div>
   <div class="table">
	     <table>
	           <tr>
	           ...
	           <tr>
	              <td><button onclick="myFunction()">Withdraw</button></td>
